...
def get_private_resource_tunnel(
    ...
    return PrivateResourceDetailResponse(
        ...
        sections=sections,
        sidebar_videos=resource.get("sidebar_videos", []),
    )
...
SUBSCRIPTION_PLANS = [
    ...
    PrivateSubscriptionPlanItem(
        id="essentiel-mensuel",
        title="Essentiel",
        description="Pour avancer avec méthode",
        price=9.99,
        currency="EUR",
        billing_period="monthly",
        features=[
        ...
        recommended=True,
        service_slug="essentiel-mensuel",
        sort_order=1,
    ),
    PrivateSubscriptionPlanItem(
        id="standard-mensuel",
        title="Standard",
        description="Accès complet aux outils",
        price=19.99,
        currency="EUR",
        billing_period="monthly",
        features=[
            "Tous les guides",
            "Générateurs projet d'études et professionnel",
            "Simulateur entretien",
            "Bibliothèque de motivations",
        ],
        service_slug="standard-mensuel",
        sort_order=2,
    ),
    PrivateSubscriptionPlanItem(
        id="premium-digital-mensuel",
        ...
        service_slug="premium-digital-mensuel",
        sort_order=3,
    ),
]
